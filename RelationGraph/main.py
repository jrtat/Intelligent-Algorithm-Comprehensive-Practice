...
from RelationGraph.func.preprocess import get_data, init_data, init_data_nli
from RelationGraph.func.get_result import build_matrix, get_similar_occupations
from RelationGraph.func.classification_nli import bert_calc_proba
from RelationGraph.func.utils.save_load import save_result, load_result
...
#--- 开始 BERT 微调与交叉验证预测 ---#
proba_bert = bert_calc_proba(device, X_fused, y, le)
...
affinity_matrix_bert = build_matrix(proba_bert, y, class_names)

# Step 4： 保存结果
save_result(proba_bert, affinity_matrix_bert, class_names, y)
...
print(get_similar_occupations("C/C++", class_names, affinity_matrix_bert))