...
rf_predict_and_evaluate(rf_clf,x_test= X_test,y_test= y_test, top_k_list= [1,2,3])
joblib.dump(rf_clf, "./func/model/rf/model_ver1/random_forest_model.pkl")
...
torch.save(save_dict1, "./func/model/mlp/model_ver1/mlp_model.pt")
...
torch.save(save_dict2, "./func/model/mlp/model_ver2/mlp_model.pt")