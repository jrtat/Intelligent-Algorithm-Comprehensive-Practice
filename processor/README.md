...
Salary（原本列叫啥忘了）：转换成月薪，“最低-最高”

Size（原本列叫啥忘了）：A：20人以下 / B：20-99人 / C：100-299人 / D：299-499人 / E：500-999人 / F：1000-9999人 / G：10000人以上 / H：未知

创新能力（原本列叫啥忘了）：1 / 2 / 3 / 4

抗压能力（原本列叫啥忘了）：1 / 2 / 3 / 4

沟通能力（原本列叫啥忘了）：1 / 2 / 3 / 4

学习能力（原本列叫啥忘了）：1 / 2 / 3 / 4

实习能力（原本列叫啥忘了）：1 / 2 / 3 / 4（无 / 6月以下 / 1年以下 / 1年以上）大模型打分

学历要求（原本列叫啥忘了）：【无任何要求 / 中专及以上 / 大专及以上 / 本科及以上 / 硕士及以上 / 博士及以上 ， 维度二：无任何要求 / 双一流 / 985、211】

城市水平（原本列叫啥忘了）：一线 / 新一线 / 二线 / 二线以下 / 外派

企业类型（原本列叫啥忘了）：Soar / Rise / Strong / Stable / Unknown

城市坐标（原本列叫啥忘了）：【经度，维度】

职业技能（原本列叫啥忘了）：非结构化文本（逗号分隔）

证书要求（原本列叫啥忘了）：非结构化文本（逗号分隔）
...
> - init.py：将原data.xls文件提取岗位、公司、城市、类型等实体类，方便后续数据的统一处理及数据挖掘。
> - process.py：通过大语言模型将提取数据的深层信息，便于构建知识图谱。
> - json2xlsx：将json文件转换为xlsx文件，便于到处和组长使用。
